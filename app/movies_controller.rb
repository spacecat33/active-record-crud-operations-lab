...
def can_find_by_multiple_attributes
  ...
  # Movie.where("title = ? AND release_date = ? AND director = ?", attributes[:title], attributes[:release_date], attributes[:director]).first
end
...
def can_destroy_all_items_at_once
  ...
  Movie.delete_all  #OR: Movie.destroy_all
end
